...
export const CHANGE_STATUS_ADMINS_SUCCESS = 'CHANGE_STATUS_ADMINS_SUCCESS';
export const CHANGE_STATUS_ADMINS_PENDING = 'CHANGE_STATUS_ADMINS_PENDING';
export const CHANGE_STATUS_ADMINS_ERROR = 'CHANGE_STATUS_ADMINS_ERROR';
