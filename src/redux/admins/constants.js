...
export const SOFT_DELETE_ADMINS_SUCCESS = 'SOFT_DELETE_ADMINS_SUCCESS';
export const SOFT_DELETE_ADMINS_PENDING = 'SOFT_DELETE_ADMINS_PENDING';
export const SOFT_DELETE_ADMINS_ERROR = 'SOFT_DELETE_ADMINS_ERROR';
